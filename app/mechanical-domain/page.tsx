    ...
    <div className="min-h-screen bg-black text-white relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 pt-28 pb-24">
        <div className="text-center mb-16">
          <p className="text-[11px] tracking-[0.3em] text-orange-400 uppercase mb-4">
            Team RUDRA · 2026–27
          </p>
          ...
          <p className="text-gray-500 text-sm mt-3 max-w-md mx-auto">
            Designing and building the rover's structural systems,
            drivetrain, and robotic arm.
          </p>
        </div>
          ...
          {members.map((m, i) => {
            const inner = (
              <>
                ...
                <p className="text-orange-400 text-[11px] tracking-widest">
                  {m.role}
                </p>
            ...
            const cls =
              'float-card glass group rounded-2xl p-6 flex flex-col items-center text-center hover:border-orange-400/30 transition-all duration-300';
