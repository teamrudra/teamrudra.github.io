    ...
    <div className="min-h-screen bg-black flex flex-col items-center justify-center py-16 relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-10 text-center z-10">
        ...
        <Link href="https://www.linkedin.com/in/danyal-reyaz/">
          <div className="bg-gray-800 p-6 w-[250px] h-[320px] mx-auto rounded-lg hover:bg-gray-700 transition-colors duration-300 flex flex-col items-center justify-between">
        ...
        <Link href="https://www.linkedin.com/in/nidhan-santa-kumar-n/">
          <div className="bg-gray-800 p-6 w-[250px] h-[320px] mx-auto rounded-lg hover:bg-gray-700 transition-colors duration-300 flex flex-col items-center justify-between">
            <img src="./corporate-member6.png" alt="Nidhan SKN" className="w-32 h-32 rounded-full" />
        ...
        <Link href="https://www.linkedin.com/in/ditsa-sarkar-7a0623228/">
          <div className="bg-gray-800 p-6 w-[250px] h-[320px] mx-auto rounded-lg hover:bg-gray-700 transition-colors duration-300 flex flex-col items-center justify-between">
            <img src="./ditsa.jfif" alt="Ditsa Sarkar" className="w-32 h-32 rounded-full" />
        ...
        <Link href="">
          <div className="bg-gray-800 p-6 w-[250px] h-[320px] mx-auto rounded-lg hover:bg-gray-700 transition-colors duration-300 flex flex-col items-center justify-between">
            <img src="./corporate-member4.jpeg" alt="Bhargavi Singh" className="w-32 h-32 rounded-full" />
        ...
        <Link href="https://www.linkedin.com/in/shivi-gupta-642651301/">
          <div className="bg-gray-800 p-6 w-[250px] h-[320px] mx-auto rounded-lg hover:bg-gray-700 transition-colors duration-300 flex flex-col items-center justify-between">
            <img src="./corporate-member5.jpeg" alt="Shivi Gupta" className="w-32 h-32 rounded-full" />
        ...
        <Link href="https://www.linkedin.com/in/snehal-gupta-44a791222/">
          <div className="bg-gray-800 p-6 w-[250px] h-[320px] mx-auto rounded-lg hover:bg-gray-700 transition-colors duration-300 flex flex-col items-center justify-between">
            <img src="./corporate-member6.jpeg" alt="Snehal Gupta" className="w-32 h-32 rounded-full" />
        ...
        <Link href="https://www.linkedin.com/in/shriya-rao-4773352bb/">
          <div className="bg-gray-800 p-6 w-[250px] h-[320px] mx-auto rounded-lg hover:bg-gray-700 transition-colors duration-300 flex flex-col items-center justify-between">
            <img src="./corporate-member7.jpeg" alt="Shriya Rao" className="w-32 h-32 rounded-full" />
