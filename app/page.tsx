...
<div className="min-h-screen bg-black flex flex-col items-center justify-center py-16 relative" id="newsletter">
  ...
  <div className="bg-gray-900 p-8 rounded-2xl shadow-lg w-[1000px] max-w-full relative flex flex-row items-center">
    <div className="flex-1 mr-8">
      <img src="newsletter.jpeg" alt="Rover Image" className="w-60 h-60 object-cover rounded-xl" />
    </div>
