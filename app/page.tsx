...
const Home = () => {
 ...
 <div
  ...
  <div className="col-span-full flex justify-center">
    ...
    <div className="bg-gray-800 p-4 sm:p-6 w-full sm:w-100 md:w-80 lg:w-80 rounded-lg hover:bg-gray-700 hover:scale-105 transform transition-transform duration-300">
