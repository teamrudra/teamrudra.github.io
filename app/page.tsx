...
<div className="grid grid-cols-1 md:grid-cols-3 justify-center gap-y-8 gap-x-4">
  {[
    ...
    },
    {
      ...
      image: 'mission2.png',
      title: 'Mission 2',
      subtitle: 'Navigation Testing and System Optimization',
      info: [
        'Develop navigation algorithms.',
        'Analyze mission data for optimization.',
        'Test rover performance in challenging terrains.',
      ],
    },
    { id: 3, image: 'mission3.png', title: 'Mission 3', subtitle: 'Environmental Analysis', info: ['Details about Mission 3.'] },
    { id: 4, image: 'mission4.png', title: 'Mission 4', subtitle: 'Advanced Communication Tests', info: ['Details about Mission 4.'] },
    { id: 5, image: 'mission5.png', title: 'Mission 5', subtitle: 'Resource Management', info: ['Details about Mission 5.'] },
    { id: 6, image: 'mission6.png', title: 'Mission 6', subtitle: 'Energy Efficiency Studies', info: ['Details about Mission 6.'] },
  ].map((mission) => (
    <div
      key={mission.id}
    ...
    >
      ...
      <div className="absolute inset-0 bg-black bg-opacity-70 flex flex-col justify-center items-center opacity-100 group-hover:opacity-0 transition-opacity duration-300 text-center px-2">
        ...
        <p className="text-sm font-normal">{mission.subtitle}</p>
      </div>
