...
const handleSubmit = async (event: React.FormEvent<HTMLFormElement>) => {
  ...
  try {
    ...
    const response = await fetch("https://script.google.com/macros/s/AKfycbzUKIjlODl2z2S9EnvJDiz2K-Q_yIAzsoWxKv5zWPnEbnJS-2G4oIecsZrUDkYAQHY/exec", {
      method: "POST",
...
<div className="min-h-screen bg-black flex flex-col items-center justify-center py-16 relative" id="newsletter">
  ...
  <div className="bg-gray-900 p-8 rounded-2xl shadow-lg w-[1000px] h-[480px] max-w-full relative flex flex-row items-center">
    ...
    <div className="flex-1 text-center">
      ...
      <form 
        name="news-letter" 
        action="https://script.google.com/macros/s/AKfycbzUKIjlODl2z2S9EnvJDiz2K-Q_yIAzsoWxKv5zWPnEbnJS-2G4oIecsZrUDkYAQHY/exec" 
        method="POST" 
        className="space-y-4"
      >
        <div className="relative">
