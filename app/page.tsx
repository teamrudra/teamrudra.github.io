...
<div className="min-h-screen bg-black text-white font-sans py-16 px-6">
  ...
  <div className="grid grid-cols-1 md:grid-cols-3 justify-center gap-y-8 gap-x-4">
    {[
      { id: 1, image: '1.png', title: ' Mission 1 : instrument Deployment and Maintainance Operation', info: '- Stage 1: Instrument Deployment – The rover moves to the instrument panel.\n
